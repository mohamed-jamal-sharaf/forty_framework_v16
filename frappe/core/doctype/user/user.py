...
class User(Document):
	...
	if TYPE_CHECKING:
		from frappe.core.doctype.app_list_table.app_list_table import AppListTable
		...
		app_list_table: DF.Table[AppListTable]
